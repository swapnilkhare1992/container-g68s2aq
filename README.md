...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g68s2aq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g68s2aq.containers.anotherwebservice.com/
...
```
git clone git@github.com:swapnilkhare1992/container-g68s2aq.git
cd container-g68s2aq
```
...
```
docker attach container-g68s2aq
```
